...
namespace TcBlackCLI
{
    ...
    public class ProjectBuildFailedException : Exception
    {
        ...
        public ProjectBuildFailedException(string message, Exception innerException)
            : base(message, innerException) { }

        protected ProjectBuildFailedException(SerializationInfo info, StreamingContext context)
            : base(info, context) { }
    }
}
